...
class AccountControllerTest {
    ...
    void showsHomePage() throws Exception {
        ...
        mockMvc.perform(get("/entel"))
                ...
                .andExpect(content().string(containsString("Tipo de archivo")))
                ...
                .andExpect(content().string(containsString("EXT_OP_CUST_POL_CREATE_CA")))
                .andExpect(content().string(containsString("EXT_OP_CUST_POL_CREATE_BA")))
                .andExpect(content().string(containsString("PIN_FLD_PARENT_NAME")))
                .andExpect(content().string(containsString("Descargar NAP CREATE_CA")))
                .andExpect(content().string(containsString("Descargar NAP CREATE_BA")))
                .andExpect(content().string(containsString("Descargar NAP o IEL")))
                .andExpect(content().string(containsString("SERVICE_TYPE")))
                .andExpect(content().string(containsString("PIN_FLD_AAC_PACKAGE")))
                .andExpect(content().string(containsString("Descargar documentacion CHANGE_NUMBER")))
                .andExpect(content().string(containsString("Descargar documentacion ADD_ASSET")))
                .andExpect(content().string(containsString("Descargar documentacion CREATE_CA")))
                .andExpect(content().string(containsString("Descargar documentacion CREATE_BA")))
                .andExpect(content().string(containsString("--SERVICIOS DE UNA CUENTA")))
                .andExpect(content().string(containsString("--Info de la cuenta")))
                .andExpect(content().string(containsString("-- Jerarquia de cuentas")))
                .andExpect(content().string(containsString("[omsuser@pje oms]$ cd sys/test")))
